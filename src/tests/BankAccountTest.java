...
public class BankAccountTest {
    ...
    public void testTransferSuccess() {
        ...
        BankAccount destinationAccount = new BankAccount(50);
    ...
    public void testSumPositiveBalances() {
        ...
        accounts.add(new BankAccount(100)); // Positive balance
        accounts.add(new BankAccount(-50)); // Negative balance
        accounts.add(new BankAccount(200)); // Positive balance
        accounts.add(new BankAccount(0)); // Zero balance
